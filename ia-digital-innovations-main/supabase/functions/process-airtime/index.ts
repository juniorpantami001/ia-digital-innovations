...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Processing airtime purchase:', { network, phoneNumber, amount, userId: user.id });
    ...
    console.log('Airtime purchase completed:', { reference, status: finalStatus });
    ...
    console.error('Error in process-airtime:', error);
    return new Response(
